...
const {
  ...
  insertUsers,
  dbDataOne,
} = require("../fixtures/user.fixtures.js");
const {
  product1,
  insertProducts,
  deleteProducts,
} = require("../fixtures/product.fixture.js");
...
const {
  deleteWishlist,
  insertWishlist,
} = require("../fixtures/wishlist.fixtures.js");
...
describe("Cart routes", () => {
  ...
  describe("GET /api/wishlist", () => {
    ...
    test("should return 200 with empty array when no products are in the wishlist", async () => {
      await deleteWishlist();
