...
const Alerts = ({
  ...
  useEffect(() => {
    ...
    if (otp_sent_status.fail) {
      enqueueSnackbar(otp_sent_status.fail, {
        variant: "warning",
        ...snackbarProps,
      });
      dispatch(resetOTPSentStatus());
    } else if (otp_sent_status.success) {
      enqueueSnackbar(otp_sent_status.success, {
        variant: "success",
        ...snackbarProps,
      });
      dispatch(resetOTPSentStatus());
...
const Form2 = ({
  ...
  return (
    <div className={showForm.form2 ? "" : "hidden"}>
      <div
        onClick={handleBack}
        className="cursor-pointer p-2 mb-5 flex items-center w-fit rounded-md hover:bg-gray-50  dark:text-gray-300 dark:hover:bg-gray-700 "
      >
...
const Form3 = ({
  ...
  useEffect(() => {
    if (password_reset_status.success) navigate("/login");
  }, [navigate, password_reset_status]);

  return (
    <div className={showForm.form3 ? "" : "hidden"}>
      <div
        onClick={handleBack}
        className="cursor-pointer p-2 mb-5 flex items-center w-fit rounded-md hover:bg-gray-50  dark:text-gray-300 dark:hover:bg-gray-700 "
      >
