...
export { default as BreadCrumb } from "./common/ProductDetail/BreadCrumb";
export { default as ProductImages } from "./common/ProductDetail/ProductImages";
export { default as ProductInfoDesktop } from "./common/ProductDetail/ProductInfoDesktop";
