...
function EditProductForm(path) {
  ...
  return (
    <>
      {newProduct && param === "homePage" && (
        <Navigate to={`/admin`}></Navigate>
      )}
      {newProduct && param === "productPage" && (
        <Navigate to={`/admin/product-detail/${newProduct.id}`}></Navigate>
      )}
      <Link
        to="/admin"
        className="p-2 mb-5 rounded-md hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700 inline-block"
      >
        <ArrowLeftIcon className="h-6 w-6 inline "></ArrowLeftIcon> Back
      </Link>
              ...
              <div className="col-span-3">
                ...
                <div className="mt-2">
                  <select
                    ...
                    id="brands"
                    className="rounded-md border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300"
                  >
