  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2 ">
        <Link
          to="/admin"
          className="p-2 rounded-md hover:bg-gray-50  dark:text-gray-300 dark:hover:bg-gray-700"
        >
        ...
        <div>
          {product && (
            <Link
              to={`/admin/edit-product-form/${product.id}?path=productPage`}
        ...
        {product && (
          <div className="pt-6">
            ...
            <Link
              to="/admin"
              aria-current="page"
              className="pl-10 text-sm font-medium text-gray-400 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-100 cursor-pointer"
            >
              Products &gt;
            ...
            <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
              ...
              <div className="mt-4 lg:row-span-3 lg:mt-0">
                ...
                <div className="grid grid-cols-1 gap-y-2">
                  <span className="text-5xl tracking-tight text-gray-900 dark:text-gray-300">
                    ₹{" "}
                    {(
                      product.price -
