                ...
                <header>
                    <div className="mx-auto ">
                        <div className="flex items-center justify-center sm:justify-between h-16 lg:h-14 flex-1">
                            ...
                            <button onClick={() => navigate('/signup')} title="" className="hidden sm:inline-flex items-center justify-center px-5 py-2 text-base transition-all duration-200 hover:bg-primary-hover hover:text-white focus:text-white focus:bg-primary-hover font-semibold text-white bg-primary rounded-full">Sign Up</button>
                        </div>
                    </div>
                </header>
                <section className='flex-1 flex flex-col md:flex-row  gap-12' >
                    <div className=' flex-1 max-h-fit text-center md:text-left'>
                        <h1 className="font-montserrat font-bold text-black text-4xl sm:text-5xl xl:text-7xl">
                            ...
                            on Products You <span className='font-allison font-extralight text-pink-500 text-5xl'> Love</span>
                        </h1>
                        <p className="font-montserrat text-sm md:text-base lg:text-lg text-black lg:mt-8 ">From fashion to electronics, find everything in one place with unbeatable prices and fast delivery.</p>
                    ...
                    <div className='flex-1 2xl:h-1/2 '>
                        <img className='object-contain h-full w-full object-top' src='/hero-image2.png' alt="Hero" />
                    </div>
                </section>
            </div>
        </div>
