                ...
                <div className="border-b border-gray-300 dark:border-gray-700 pb-12  grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-full ">
                    ...
                    <div className="mt-2">
                      ...
                      />
                      <span className="md:ml-2 block md:inline mt-2 md:mt-0 font-medium text-sm dark:text-gray-300">
                        OR
                      </span>
                      <input
                        type="file"
                      ...
                      <div className="mt-2 space-y-6">
                        <ul className="flex flex-col gap-2">
                          {user.addresses.map((address, index) => (
                            <li
                              key={index}
                              className="items-baseline border dark:border-transparent px-5 bg-white dark:bg-gray-800"
                            >
