    ...
    <div className="flex items-center justify-between border-t border-gray-200 bg-white dark:border-transparent dark:bg-gray-800  pt-6 ">
      <div className="flex flex-1 justify-between sm:hidden">
        <button
          ...
          className={`relative inline-flex items-center rounded-md border border-gray-300   px-4 py-2 text-sm font-medium ${page - 1 < 1
        ...
        <button
          ...
          className={`relative inline-flex items-center rounded-md border border-gray-300   px-4 py-2 text-sm font-medium ${page + 1 > totalPages
              ? "bg-gray-100 text-gray-300 dark:bg-gray-800 dark:text-gray-700 cursor-auto dark:border-gray-700 "
              : "text-gray-700 dark:text-gray-400 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-gray-200 dark:border-gray-500 "
            }`}
        >
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            <div
              onClick={handlePrev}
              className={`relative inline-flex items-center rounded-l-md border px-2 py-2 text-sm font-medium ${page - 1 < 1
                  ? "bg-gray-100 text-gray-300 dark:bg-gray-800 dark:text-gray-700 cursor-auto dark:border-gray-700 "
                  : "text-gray-700 dark:text-gray-400 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-gray-200 dark:border-gray-500 "
                }`}
            >
            ...
            {Array.from({ length: 10 }).map((items, index) => (
              <div
                ...
                aria-current="page"
                className={`w-10 justify-center relative z-10 inline-flex items-center dark:border-gray-500 ${index + 1 + pageBoundary.index === page
            ...
            <div
              onClick={handleNext}
              className={`relative inline-flex items-center rounded-r-md border px-2 py-2 text-sm font-medium ${page + 1 > totalPages
                  ? "bg-gray-100 text-gray-300 dark:bg-gray-800 dark:text-gray-700 cursor-auto dark:border-gray-700 "
                  : "text-gray-700 dark:text-gray-400 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-gray-200 dark:border-gray-500 "
                }`}
            >
